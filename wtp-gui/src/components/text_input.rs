...
pub fn init(cx: &mut App) {
    cx.bind_keys([
        ...
        gpui::KeyBinding::new("shift-backspace", Backspace, Some("TextInput")),
        ...
        gpui::KeyBinding::new("ctrl-a", SelectAll, Some("TextInput")),
        #[cfg(target_os = "macos")]
        gpui::KeyBinding::new("cmd-v", Paste, Some("TextInput")),
        #[cfg(not(target_os = "macos"))]
        gpui::KeyBinding::new("ctrl-v", Paste, Some("TextInput")),
        #[cfg(target_os = "macos")]
        gpui::KeyBinding::new("cmd-c", Copy, Some("TextInput")),
        #[cfg(not(target_os = "macos"))]
        gpui::KeyBinding::new("ctrl-c", Copy, Some("TextInput")),
        #[cfg(target_os = "macos")]
        gpui::KeyBinding::new("cmd-x", Cut, Some("TextInput")),
        #[cfg(not(target_os = "macos"))]
        gpui::KeyBinding::new("ctrl-x", Cut, Some("TextInput")),
...
impl gpui::Element for TextElement {
    ...
    fn prepaint(
        ...
        let (display_text, text_color, text_font) = if content.is_empty() {
            (
                input.placeholder.clone(),
                theme::text_tertiary().into(),
                theme::mono_font().italic(),
            )
        } else {
            (content, style.color, theme::mono_font())
        };
    ...
    fn paint(
        ...
        let line = prepaint.line.take().expect("text input line should exist");
        line.paint(
            bounds.origin,
            window.line_height(),
            gpui::TextAlign::Left,
